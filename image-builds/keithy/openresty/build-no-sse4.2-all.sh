...
#./docker-build-openresty.sh alpine 3.10 no-sse4.2 std none build+push
#./docker-build-openresty.sh alpine 3.10 no-sse4.2 fat none build+push
#./docker-build-openresty.sh alpine 3.10 no-sse4.2 fat autossl build+push
#./docker-build-openresty.sh alpine 3.10 no-sse4.2 std autossl build+push
